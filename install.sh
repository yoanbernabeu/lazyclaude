...
echo ""
echo "   🍎 iTerm2 detected? CC mode is automatic!"
echo "      Use native Cmd+D / Cmd+Opt+Arrow shortcuts."
echo "      Force classic mode: lazyclaude --no-cc"
echo "      Force CC mode:      lazyclaude --cc"
